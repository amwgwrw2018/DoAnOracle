                    ...
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-post featured-post single-post">
                            <div class="post-thumb">
                                <a href="#"><img src="<%=request.getContextPath()%>/img/${nsp.mainimage}" alt="" style="width:800px;heihgt:200px;"></a>
                            </div>
                            <div class="post-data">
                                <a href="#" class="post-catagory">${nsp.newspaperType}</a>
                                <a href="#" class="post-title">
                                    <h6>${nsp.title }</h6>
                                </a>
                                <div class="post-meta">
                               
                                    <pre><span style="font-size:22px;">
                                    ${newspaperContent}
                                    </span></pre>
